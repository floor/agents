...
export { runProjectCommand, validateWorktree, verifyWorktree, verificationSummary, VerificationFailed, isRepairableGateFailure, latestFailingCheck, gateFailureSection, lastLines } from './verification.ts'
