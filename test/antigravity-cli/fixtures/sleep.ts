...
// AntigravityTimeoutError. If AGY_TEST_RECORD is set, records cwd first so a test can
...
// Prove the adapter's timeout kill is not just a SIGTERM a real hung `agy` could
